...
<!-- filter -->
  ...
  <?php $query = mysqli_query($conn,"SELECT * FROM joblist ORDER BY id ASC");?>
  ...
  ?>
        ...
        <div class="row">
          ...
          <div class="col-sm col-sm-7">
              <a href="single-job.php?id=<?php echo $data['id'];?>" class="title"> <h3><?php echo $data["jobName"];?></h3> </a>
          ...
          <div class="col-sm col-sm-3 text-center">
            <a href="single-job.php?id=<?php echo $data['id'];?>" class="btn btn-primary">Apply Now</a>
